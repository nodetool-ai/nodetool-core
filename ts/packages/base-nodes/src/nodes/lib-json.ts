...
export class ParseDictLibNode extends BaseNode {
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const parsed = JSON.parse(String(inputs.json_string ?? this._props.json_string ?? ""));
...
export class StringifyJSONLibNode extends BaseNode {
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const data = inputs.data ?? this._props.data ?? {};
    const indent = Number(inputs.indent ?? this._props.indent ?? 2);
...
export class GetJSONPathStrLibNode extends BaseGetJSONPathNode {
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    ...
    const fallback = String(inputs.default ?? this._props.default ?? "");
...
export class GetJSONPathIntLibNode extends BaseGetJSONPathNode {
  ...
  defaults() {
    return { data: {}, path: "", default: 0 };
  }

  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const value = this.extract(inputs);
    const fallback = Number(inputs.default ?? this._props.default ?? 0);
...
export class GetJSONPathBoolLibNode extends BaseGetJSONPathNode {
  ...
  defaults() {
    return { data: {}, path: "", default: false };
  }

  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const value = this.extract(inputs);
    const fallback = Boolean(inputs.default ?? this._props.default ?? false);
...
export class GetJSONPathListLibNode extends BaseGetJSONPathNode {
  ...
  defaults() {
    return { data: {}, path: "", default: [] as unknown[] };
  }

  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const value = this.extract(inputs);
    const fallback = Array.isArray(inputs.default ?? this._props.default)
      ? (inputs.default ?? this._props.default ?? [])
      : [];
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    ...
    const fallback =
      inputs.default && typeof inputs.default === "object" && !Array.isArray(inputs.default)
        ...
        : this._props.default && typeof this._props.default === "object" && !Array.isArray(this._props.default)
          ? (this._props.default as Record<string, unknown>)
          : {};
...
export class ValidateJSONLibNode extends BaseNode {
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const data = inputs.data ?? this._props.data ?? {};
    const schema = inputs.json_schema ?? this._props.json_schema ?? {};
...
export class FilterJSONLibNode extends BaseNode {
  ...
  defaults() {
    return { array: [] as Record<string, unknown>[], key: "", value: {} };
  }

  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    const array = (inputs.array ?? this._props.array ?? []) as unknown[];
...
export class JSONTemplateLibNode extends BaseNode {
  ...
  defaults() {
    return { template: "", values: {} as Record<string, unknown> };
  }

  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    let result = String(inputs.template ?? this._props.template ?? "");
...
export class LoadJSONAssetsLibNode extends BaseNode {
  ...
  async *genProcess(inputs: Record<string, unknown>): AsyncGenerator<Record<string, unknown>> {
    const folder = inferLocalFolder(inputs.folder ?? this._props.folder ?? { uri: "" });
    if (!folder) {
