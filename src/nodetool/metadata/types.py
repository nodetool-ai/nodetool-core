...
class Message(BaseType):
    ...
    use_claude_agent_sdk: bool | None = None
    """
    Whether to use Claude Agent SDK (Anthropic's tool_runner) for agent mode.
    Only applicable when agent_mode is True and provider is Anthropic.
    When True, uses Anthropic's native agentic loop instead of the custom nodetool agent.
    """
