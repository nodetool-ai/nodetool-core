...
class JobSession:
    ...
    async def start_job(
        ...
        # _event_loop is guaranteed to be non-None after the is_running check above
        assert self._event_loop is not None, "Event loop should be initialized after start()"
