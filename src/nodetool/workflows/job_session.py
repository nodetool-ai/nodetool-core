...
class JobSession:
    ...
    async def start_job(
        ...
        # At this point, _event_loop is guaranteed to be non-None due to the check above
        event_loop = cast("ThreadedEventLoop", self._event_loop)
        ...
        job.future = event_loop.run_coroutine(job.execute())
