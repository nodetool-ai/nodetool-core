...
def _determine_chat_log_level(explicit_level: str | None = None) -> str:
...
class ChatCLI:
    ...
    def __init__(self):
        ...
        self.selected_model: LanguageModel | None = None
        self.model_id_from_settings: str | None = None
        self.selected_provider: Provider | None = None
        ...
        self.planner_model_id: str | None = None
        self.summarization_model_id: str | None = None
        self.retrieval_model_id: str | None = None
    ...
    def _build_command_completer(self) -> NestedCompleter:
        ...
        command_completer: dict[str, WordCompleter | None] = dict.fromkeys(self.commands.keys())
