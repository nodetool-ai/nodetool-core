...
class MigrationRunner:
    ...
    def __init__(
        ...
        Args:
            connection_or_adapter: Either a MigrationDBAdapter instance or
                                   ...
                                   in an appropriate adapter).
            migrations_dir: Optional custom migrations directory
        """
        # Accept either an adapter or a raw connection
        if isinstance(connection_or_adapter, MigrationDBAdapter):
    ...
    @property
    def adapter(self) -> MigrationDBAdapter:
    ...
    async def _acquire_lock(self, timeout: float = 30.0) -> bool:
        ...
        while time.time() - start_time < timeout:
            ...
            row = await self._adapter.fetchone(
