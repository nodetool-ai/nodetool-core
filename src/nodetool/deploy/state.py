...
class StateManager:
    ...
    def write_state(
        ...
        with self.lock():
            ...
            deployment.state = deployment.state.__class__.model_validate(current_state)  # type: ignore
    ...
    def clear_state(self, deployment_name: str) -> None:
        ...
        with self.lock():
            ...
            deployment.state = deployment.state.__class__()  # type: ignore
...
def restore_state_from_snapshot(
    ...
    with state_manager.lock():
        ...
        for name in deployments_to_restore:
            ...
            # Restore state
            deployment.state = deployment.state.__class__.model_validate(snapshot_state)  # type: ignore
