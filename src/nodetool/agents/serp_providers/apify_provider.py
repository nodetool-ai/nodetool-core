...
class ApifyProvider(SerpProvider):
    ...
    async def search_raw(
        ...
        Apify uses individual actors for different search types rather than
        a generic engine system like SerpApi.
        """
        return {"error": "Generic search_raw is not supported by Apify provider. Use specific search methods instead."}
