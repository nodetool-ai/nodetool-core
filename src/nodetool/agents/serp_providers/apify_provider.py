...
class ApifyProvider(SerpProvider):
    ...
    async def search_raw(
        ...
        Not currently supported by ApifyProvider as it uses actor-based approach.
        """
        return {"error": "Raw search not supported by Apify provider. Use specific search methods instead."}
