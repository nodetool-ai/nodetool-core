...
class DataForSEOProvider(SerpProvider):
    ...
    async def search_raw(
        ...
        """
        Generic search method for any engine.
        Not currently supported by DataForSEOProvider as it uses endpoint-based approach.
        """
        return {"error": "Raw search not supported by DataForSEO provider. Use specific search methods instead."}
