...
class DataForSEOProvider(SerpProvider):
    ...
    async def search_raw(
        ...
        """
        Generic search method that sends a request to any engine.
        Not currently supported by DataForSEOProvider natively matching SerpApi.
        """
        return {"error": "Generic raw search not supported by DataForSEO provider"}
