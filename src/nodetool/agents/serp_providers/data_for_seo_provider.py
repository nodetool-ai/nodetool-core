...
class DataForSEOProvider(SerpProvider):
    ...
    async def search_raw(
        ...
        Currently not supported natively across all DataForSEO engines in the same way as SerpAPI.
        """
        return {"error": "DataForSEOProvider does not support generic search_raw yet."}
