...
3. **Subtask Instructions:** The `content` field MUST contain high-level natural language instructions for the agent executing the subtask. Do NOT include `tool_name`.
4. Specify correct `output_type` and `output_schema` (as a JSON string) for each subtask.
5. Ensure dependencies are correctly expressed via `input_files`, reflecting the data flow defined in Phase 2.
