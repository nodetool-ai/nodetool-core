...
async def _get_configured_serp_provider(
    ...
    Prioritizes SerpApi, then Brave Search, then DataForSEO.
    ...
    if serpapi_key:
        ...
        return None, {"error": "No SERP provider is configured. Please set credentials for SerpApi, Brave Search, or DataForSEO."}
