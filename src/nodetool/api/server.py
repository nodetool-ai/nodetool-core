...
def create_app(
    ...
    *,
    ...
    startup_vars = {
        ...
        "LLAMA_CPP_URL": Environment.get("LLAMA_CPP_URL"),
        "LMSTUDIO_API_URL": Environment.get("LMSTUDIO_API_URL"),
        "VLLM_BASE_URL": Environment.get("VLLM_BASE_URL"),
