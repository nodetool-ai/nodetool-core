...
@router.get("/list")
async def list_files(path: str = ".", __user: str = Depends(CurrentUser())) -> List[FileInfo]:
    """
...
@router.get("/info")
async def get_file(path: str, __user: str = Depends(CurrentUser())) -> FileInfo:
    """
...
async def download_file(path: str, __user: str = Depends(CurrentUser())):
    """
...
async def upload_file(path: str, file: UploadFile, __user: str = Depends(CurrentUser())):
    """
...
async def list_workspaces(__user: str = Depends(CurrentUser())) -> List[WorkspaceInfo]:
    """
...
async def get_workspace_info(workspace_id: str, __user: str = Depends(CurrentUser())) -> WorkspaceInfo:
    """
...
async def list_workspace_files(
    workspace_id: str, path: str = ".", __user: str = Depends(CurrentUser())
) -> List[FileInfo]:
    """
...
async def download_workspace_file(workspace_id: str, file_path: str, __user: str = Depends(CurrentUser())):
    """
...
async def upload_workspace_file(
    ...
    file_path: str,
    file: UploadFile,
    __user: str = Depends(CurrentUser()),
):
    """
