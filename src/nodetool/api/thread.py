...
@router.post("/")
async def create(req: ThreadCreateRequest, user: str = Depends(CurrentUser())) -> Thread:
...
async def get(thread_id: str, user: str = Depends(CurrentUser())) -> Thread:
...
async def delete(thread_id: str, user: str = Depends(CurrentUser())) -> None:
...
async def summarize_thread(thread_id: str, req: ThreadSummarizeRequest, user: str = Depends(CurrentUser())) -> Thread:
