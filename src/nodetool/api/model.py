...
async def get_ollama_model_info_endpoint(model_name: str, user: CurrentUserDep) -> dict | None:
...
async def check_huggingface_cache(body: HFCacheCheckRequest, user: CurrentUserDep) -> HFCacheCheckResponse:
    """
...
async def check_huggingface_cache_status(
    body: list[HFFastCacheStatusRequest], _user: CurrentUserDep
...
if not Environment.is_production():
    ...
    async def pull_ollama_model(model_name: str, user: CurrentUserDep):
