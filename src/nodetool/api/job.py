...
async def get_job(job_id: str, user_id: str = Depends(CurrentUser())):
    """
...
async def list_running_jobs(user_id: str = Depends(CurrentUser())):
    """
...
async def cancel_job(job_id: str, user_id: str = Depends(CurrentUser())) -> BackgroundJobResponse:
    """
...
async def list_running_trigger_workflows(user_id: str = Depends(CurrentUser())):
    """
...
async def start_trigger_workflow(workflow_id: str, user_id: str = Depends(CurrentUser())):
    """
...
async def stop_trigger_workflow(workflow_id: str, user_id: str = Depends(CurrentUser())):
    """
