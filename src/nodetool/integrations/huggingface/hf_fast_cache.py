...
async def _read_current_ref_async(repo_dir: Path) -> Tuple[Optional[float], Optional[str]]:
    ...
    return (newest_mtime if newest_mtime is not None else await _mtime_or_none_async(refs_dir), newest_commit)
