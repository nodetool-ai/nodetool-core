...
class GroqProvider(OpenAIProvider):
    ...
    async def generate_message(  # type: ignore[override]
        ...
        **kwargs,
        ...
        """Generate a non-streaming completion from Groq.

        This method extends OpenAI's generate_message for Groq.
        ...
        log.debug("Making non-streaming API call to Groq")
    ...
    async def generate_messages(  # type: ignore[override]
        ...
        **kwargs,
        ...
        """Stream assistant deltas and tool calls from Groq.

        This method extends OpenAI's generate_messages for Groq.
        ...
        log.debug(f"Converting {len(messages)} messages to OpenAI format")
        openai_messages = [await self.convert_message(m) for m in messages]
        log.debug("Making streaming API call to Groq")
