...
class AnthropicProvider(BaseProvider):
    ...
    def _setup_structured_output(
        ...
        if not response_format:
            formatted_tools = self.format_tools(tools or [])
            # Cast ToolParam list to dict list for type compatibility
            return [cast("dict", t) for t in formatted_tools], None, False  # type: ignore[list-item]
