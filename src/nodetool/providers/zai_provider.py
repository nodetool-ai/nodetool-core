...
class ZAIProvider(OpenAIProvider):
    ...
    async def generate_message(  # type: ignore[override]
        ...
        **kwargs,
        ...
        """Generate a non-streaming completion from Z.AI.

        This method extends OpenAI's generate_message for Z.AI.
        ...
        log.debug("Making non-streaming API call to Z.AI")
        ...
        log.debug("Received response from Z.AI API")
    ...
    async def generate_messages(  # type: ignore[override]
        ...
        **kwargs,
        ...
        """Stream assistant deltas and tool calls from Z.AI.

        This method extends OpenAI's generate_messages for Z.AI.
        ...
        log.debug(f"Converting {len(messages)} messages to OpenAI format")
        openai_messages = [await self.convert_message(m) for m in messages]
        log.debug("Making streaming API call to Z.AI")
