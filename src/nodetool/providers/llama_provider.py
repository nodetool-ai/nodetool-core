...
class LlamaProvider(BaseProvider, OpenAICompat):
    ...
    def get_client(self, base_url: str) -> openai.AsyncClient:
        ...
        try:
            ...
            http_client = httpx.AsyncClient(follow_redirects=True, timeout=600, verify=True)
    ...
    async def _fetch_server_model_ids(self) -> list[str]:
        ...
        try:
            async with httpx.AsyncClient(timeout=httpx.Timeout(2.0, connect=0.5), verify=True) as client:
