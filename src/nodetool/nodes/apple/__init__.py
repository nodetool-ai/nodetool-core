...
_calendar_mod.CreateCalendarEvent = _make_node_class("CreateCalendarEvent", False)  # type: ignore[attr-defined]
_calendar_mod.ListCalendarEvents = _make_node_class("ListCalendarEvents", False)  # type: ignore[attr-defined]
...
_notes_mod.escape_for_applescript = escape_for_applescript  # type: ignore[attr-defined]
_notes_mod.CreateNote = _make_node_class("CreateNote", False)  # type: ignore[attr-defined]
_notes_mod.ReadNotes = _make_node_class("ReadNotes", False)  # type: ignore[attr-defined]
...
_messages_mod.SendMessage = _make_node_class("SendMessage", False)  # type: ignore[attr-defined]
...
_speech_mod.SayText = _make_node_class("SayText", False)  # type: ignore[attr-defined]
...
_dictionary_mod.SearchDictionary = _make_node_class("SearchDictionary", True)  # type: ignore[attr-defined]
