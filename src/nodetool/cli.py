...
def serve(
    ...
    """
    from nodetool.api.cli_serve import run_serve as _run_serve
...
def deploy_show(name: str):
    ...
    try:
        ...
        show_deployment_details(name, deployment, state)
...
def deploy_add(name: str, deployment_type: str):
    ...
    from nodetool.deploy.configure import (
        configure_docker,
        configure_gcp,
        configure_local,
        configure_runpod,
    ...
    try:
        ...
        if deployment_type == "docker":
            deployment = configure_docker(name, console)
        elif deployment_type == "ssh":
            deployment = configure_ssh(name, console)
        elif deployment_type == "local":
            deployment = configure_local(name, console)
        elif deployment_type == "runpod":
            deployment = configure_runpod(name, console)
        elif deployment_type == "gcp":
            deployment = configure_gcp(name, console)
