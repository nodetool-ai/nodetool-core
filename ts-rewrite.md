...
**Test Summary**: 127 tests across 14 test files, all passing.
...
- `@nodetool/runtime` – ProcessingContext, MemoryCache, output sanitization, storage adapters, output normalization
