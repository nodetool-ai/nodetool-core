...
class TestCacheDirectory:
    ...
    def test_cache_directory_creation(self, tmp_path):
        ...
        with patch(
            "nodetool.integrations.huggingface.huggingface_models.get_model_info_cache_directory",
    ...
    @patch("nodetool.integrations.huggingface.huggingface_models.Path.mkdir")
...
class TestCacheFileOperations:
    ...
    def test_write_cache_with_size_verification(self, tmp_path):
        ...
        with patch(
            ...
            expected_size = len(
                json.dumps(cache_content, indent=2, default=str).encode("utf-8")
            )
...
class TestCacheExpiration:
    ...
    def test_configurable_cache_expiry(self, tmp_path):
        ...
        importlib.reload(nodetool.integrations.huggingface.huggingface_models)
