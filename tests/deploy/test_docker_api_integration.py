...
class TestDockerAPIIntegration:
    ...
    def test_create_workflow(self, docker_client, api_base_url):
        ...
        try:
            # Create a simple workflow using test helper nodes
            workflow_data = {
                "name": "test-sum-workflow",
                "description": "Test workflow that sums numbers",
                "access": "private",
                "graph": {
                    "nodes": [
                        {
    ...
    def test_run_workflow(self, docker_client, api_base_url):
        ...
        try:
            # First create a workflow using test helper nodes
            workflow_data = {
    ...
    def test_workflow_execution_result(self, docker_client, api_base_url):
        ...
        try:
            # Create a workflow that produces a known result
            workflow_data = {
                    ...
                    for job in jobs_data.get("jobs", []):
                        if job.get("workflow_id") == workflow_id:
                            ...
                            if status == "completed":
                                ...
                                # We expect the value to be 42, but we can't directly check output
            ...
            workflow_data = {
                ...
                "graph": {
                    "nodes": [
                        ...
                        {
                            "id": "pass",
                            "type": "nodetool.workflows.test_helper.PassThrough",
                            "data": {"prefix": "test"},
                        },
                        {
                            "id": "output",
