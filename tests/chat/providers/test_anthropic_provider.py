...
class TestAnthropicBaseUrl:
    ...
    def test_provider_without_base_url(self, monkeypatch):
        ...
        # Client should use default Anthropic API URL
        assert provider.client.base_url.host == "api.anthropic.com"
    ...
    def test_provider_with_base_url(self, monkeypatch):
        ...
        assert provider.client.base_url.host == "custom-api.example.com"
