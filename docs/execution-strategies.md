...
**Audience:** Workflow authors and operators.  
**What you will learn:** How NodeTool runs jobs across threaded, subprocess, and Docker strategies, plus limits, security, testing, and design notes.
