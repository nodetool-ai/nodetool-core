...
**Audience:** Desktop/app developers and contributors.  
**What you will learn:** How the Editor API (`nodetool serve`) is structured and how it differs from the deployable Worker API.
