...
RUN echo "Installing nodetool packages..." && \
    ...
    git+https://github.com/nodetool-ai/nodetool-lib-audio \
    git+https://github.com/nodetool-ai/nodetool-lib-data \
    git+https://github.com/nodetool-ai/nodetool-lib-image \
    git+https://github.com/nodetool-ai/nodetool-lib-ml \
    git+https://github.com/nodetool-ai/nodetool-lib-network \
    git+https://github.com/nodetool-ai/nodetool-huggingface

RUN echo "Installing nodetool-huggingface with PyTorch..." && \
    uv pip install --no-cache-dir git+https://github.com/nodetool-ai/nodetool-huggingface --extra-index-url https://download.pytorch.org/whl/cu121
