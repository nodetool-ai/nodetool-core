...
- **Async TTL Cache**: `AsyncTTLCache` for time-based caching with automatic expiration, LRU eviction, and background cleanup, useful for caching API responses and expensive computations
