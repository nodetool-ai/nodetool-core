...
- **Async CountDownLatch**: `AsyncCountDownLatch` for coordinating multiple async tasks, allowing tasks to wait until a count reaches zero (useful for waiting on concurrent operations)
