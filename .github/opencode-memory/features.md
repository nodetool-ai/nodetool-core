...
- **Async TTL Cache**: `AsyncTTLCache` for caching expensive async operations with TTL expiration, LRU eviction, cache stampede prevention, and stale-while-revalidate support
