...
- **Async LRU Cache**: `AsyncLRUCache` and `async_cached` decorator for thread-safe caching of async function results with TTL support, LRU eviction, cache statistics, and thundering herd prevention
