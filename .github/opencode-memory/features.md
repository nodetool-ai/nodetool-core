...
- **Async Cache**: `AsyncCache` for caching async operations with TTL (time-to-live) expiration, LRU (least-recently-used) eviction, async factory functions, and statistics tracking
