...
- **Async Cache**: `AsyncCache` and `cached_async` decorator for memoizing expensive async operations with TTL and size limits, useful for caching API calls and database queries
