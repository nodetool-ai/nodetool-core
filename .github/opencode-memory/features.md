...
- **Async Counter**: `AsyncCounter` for thread-safe atomic counting in async operations, supports increment, decrement, add, reset, and atomic get-and-set operations
