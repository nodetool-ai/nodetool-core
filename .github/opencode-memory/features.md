...
- **Async Pool**: `AsyncPool` and `AsyncPoolContext` for reusable resource pooling with acquire/release semantics, lazy initialization, optional cleanup, stats tracking, and graceful shutdown
