- **2026-01-15**: Fixed test timeout issue in Makefile - Added timeout wrapper (60s) for job execution tests to prevent indefinite hangs during async teardown. Tests timeout gracefully with `|| true` fallback.
